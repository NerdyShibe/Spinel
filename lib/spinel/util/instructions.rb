...
module Spinel
  module Data # rubocop:disable Metrics/ModuleLength
    ...
    CPU_INSTRUCTIONS = [
      ...
      { opcode: 0x40, mnemonic: 'LD B, B', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[b= b] },
      { opcode: 0x41, mnemonic: 'LD B, C', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[b= c] },
      { opcode: 0x42, mnemonic: 'LD B, D', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[b= d] },
      { opcode: 0x43, mnemonic: 'LD B, E', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[b= e] },
      { opcode: 0x44, mnemonic: 'LD B, H', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[b= h] },
      { opcode: 0x45, mnemonic: 'LD B, L', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[b= l] },
      { opcode: 0x46, mnemonic: 'LD B, (HL)', length: 1, cycles: 8, method: :load_r8_mem, operands: %i[b hl] },
      { opcode: 0x47, mnemonic: 'LD B, A', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[b= a] },
      { opcode: 0x48, mnemonic: 'LD C, B', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[c= b] },
      { opcode: 0x49, mnemonic: 'LD C, C', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[c= c] },
      { opcode: 0x4A, mnemonic: 'LD C, D', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[c= d] },
      { opcode: 0x4B, mnemonic: 'LD C, E', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[c= e] },
      { opcode: 0x4C, mnemonic: 'LD C, H', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[c= h] },
      { opcode: 0x4D, mnemonic: 'LD C, L', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[c= l] },
      { opcode: 0x4E, mnemonic: 'LD C, (HL)', length: 1, cycles: 8, method: :load_r8_mem, operands: %i[c hl] },
      { opcode: 0x4F, mnemonic: 'LD C, A', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[c= a] },
      { opcode: 0x50, mnemonic: 'LD D, B', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[d= b] },
      { opcode: 0x51, mnemonic: 'LD D, C', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[d= c] },
      { opcode: 0x52, mnemonic: 'LD D, D', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[d= d] },
      { opcode: 0x53, mnemonic: 'LD D, E', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[d= e] },
      { opcode: 0x54, mnemonic: 'LD D, H', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[d= h] },
      { opcode: 0x55, mnemonic: 'LD D, L', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[d= l] },
      { opcode: 0x56, mnemonic: 'LD D, (HL)', length: 1, cycles: 8, method: :load_r8_mem, operands: %i[d hl] },
      { opcode: 0x57, mnemonic: 'LD D, A', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[d= a] },
      { opcode: 0x58, mnemonic: 'LD E, B', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[e= b] },
      { opcode: 0x59, mnemonic: 'LD E, C', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[e= c] },
      { opcode: 0x5A, mnemonic: 'LD E, D', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[e= d] },
      { opcode: 0x5B, mnemonic: 'LD E, E', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[e= e] },
      { opcode: 0x5C, mnemonic: 'LD E, H', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[e= h] },
      { opcode: 0x5D, mnemonic: 'LD E, L', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[e= l] },
      { opcode: 0x5E, mnemonic: 'LD E, (HL)', length: 1, cycles: 8, method: :load_r8_mem, operands: %i[e hl] },
      { opcode: 0x5F, mnemonic: 'LD E, A', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[e= a] },
      { opcode: 0x60, mnemonic: 'LD H, B', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[h= b] },
      { opcode: 0x61, mnemonic: 'LD H, C', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[h= c] },
      { opcode: 0x62, mnemonic: 'LD H, D', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[h= d] },
      { opcode: 0x63, mnemonic: 'LD H, E', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[h= e] },
      { opcode: 0x64, mnemonic: 'LD H, H', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[h= h] },
      { opcode: 0x65, mnemonic: 'LD H, L', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[h= l] },
      { opcode: 0x66, mnemonic: 'LD H, (HL)', length: 1, cycles: 8, method: :load_r8_mem, operands: %i[h hl] },
      { opcode: 0x67, mnemonic: 'LD H, A', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[h= a] },
      { opcode: 0x68, mnemonic: 'LD L, B', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[l= b] },
      { opcode: 0x69, mnemonic: 'LD L, C', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[l= c] },
      { opcode: 0x6A, mnemonic: 'LD L, D', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[l= d] },
      { opcode: 0x6B, mnemonic: 'LD L, E', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[l= e] },
      { opcode: 0x6C, mnemonic: 'LD L, H', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[l= h] },
      { opcode: 0x6D, mnemonic: 'LD L, L', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[l= l] },
      { opcode: 0x6E, mnemonic: 'LD L, (HL)', length: 1, cycles: 8, method: :load_r8_mem, operands: %i[l hl] },
      { opcode: 0x6F, mnemonic: 'LD L, A', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[l= a] },
      ...
      { opcode: 0x78, mnemonic: 'LD A, B', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[a= b] },
      { opcode: 0x79, mnemonic: 'LD A, C', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[a= c] },
      { opcode: 0x7A, mnemonic: 'LD A, D', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[a= d] },
      { opcode: 0x7B, mnemonic: 'LD A, E', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[a= e] },
      { opcode: 0x7C, mnemonic: 'LD A, H', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[a= h] },
      { opcode: 0x7D, mnemonic: 'LD A, L', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[a= l] },
      { opcode: 0x7E, mnemonic: 'LD A, (HL)', length: 1, cycles: 8, method: :load_r8_mem, operands: %i[a hl] },
      { opcode: 0x7F, mnemonic: 'LD A, A', length: 1, cycles: 4, method: :ld_r8_r8, operands: %i[a= a] },
